...
return $http.get("http://localhost:1234/Homework_8/Current_Working/index.php?sym="+str)
        ...
        PageRender:
            ...
            if($('#myCarousel').find('.active').index() ==0){
                    $('#myCarousel').carousel('next');
                     ...
                     $.get("http://localhost:1234/Homework_8/Current_Working/index.php", {feedInput: inputValue})
                ...
                $('#resultTable').append(fail1);
                    ...
                    $.get("http://localhost:1234/Homework_8/Current_Working/index.php", {inputValue: inputValue})
                        .done(function (data) 
                        {
...
//Code for Star button when clicked
    ...
    function refreshNow()
    {
        ...
        $.ajax({
            url:'http://localhost:1234/Homework_8/Current_Working/index.php',
